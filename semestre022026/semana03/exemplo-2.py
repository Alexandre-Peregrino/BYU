...
def main():
    ...
    odom_inicial = float(input("Digite a leitura anterior do odômetro em quilômetros: "))
    odom_final = float(input("Digite a leitura atual do odômetro em quilômetros: "))
    combustivel = float(input("Digite a quantidade de combustível consumido: "))

    consumo = quilometros_por_litro(odom_inicial, odom_final, combustivel)
